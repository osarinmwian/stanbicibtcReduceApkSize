                        ...
                        >
                            ...
                            <BaseButton onPress={() => navigation.navigate("EditCategoryNameScreen")}>
                                <Box my="lg" alignItems="center" flexDirection="row">
                                    <Text color="primaryColor" fontWeight="500" fontSize={RFValue(12)}>EDIT CATEGORY NAME</Text>
                                    <Box ml="sm">
                            ...
                            <Box my="lg" alignItems="center" flexDirection="row">
                                <Text color="primaryColor" fontWeight="400" fontSize={14}>TRANSACTIONS</Text>
                            </Box>
                        </Box>
