          ...
          <Box
            ...
            <Box>
              ...
              <Box paddingVertical="lg">
                ...
                />
                <BaseButton flexDirection="row" justifyContent="space-between" backgroundColor="superlightGrey" marginTop="mmd" height={61} borderRadius="sm" onPress={handleMorePresent}>
                ...
                />
                  ...
                  <BaseButton backgroundColor="transparent" onPress={handleMorePresent}>
                    <Image source={arrow_down} height={16} width={16} resizeMode="contain" paddingHorizontal="sm"/>
                  </BaseButton>
                </BaseButton>
                 <Text
                  style={style.text}
                ...
                <Box backgroundColor="superlightGrey" height={61} flexDirection="row" marginBottom="lg" paddingHorizontal="sm" borderRadius="sm" alignItems="center">
                  <BaseButton backgroundColor="userGrey" height={40} width={40} justifyContent="center" onPress={handleMorePresent}>
                  <Image source={user} height={20} width={20} justifyContent="center" alignItems="center"/>
                  </BaseButton>
                  <Box flexDirection="column" justifyContent="center">
                    <Text paddingLeft="sm" color="textTint">{t("mybank.AddNewBeneficiary.recipient")}</Text>
