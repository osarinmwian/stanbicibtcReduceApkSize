...
import DestinationModal from "../hotel/components/DestinationModal";
import ArrivalAndDepartureModal from "../hotel/components/ArrivalAndDepartureModal";

const PassengerDetails: FC = ({
  navigation,
}: MyBankNavigationProps<"PassengerDetails">) => {
  const titleData = [
    { id: "1", name: "Mr" },
    { id: "1", name: "Mrs" },
  ];
  ...
  const renderHeader = () => (
    ...
    >
      ...
      <Text variant="medium14" color="whiteColor">
        PASSENGERS DETAILS
      </Text>
      <Text />
    </Box>
