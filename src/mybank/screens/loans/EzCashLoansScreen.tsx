...
const EZCashLoansScreen: VFC<LoansNavigationProps<"Loans">> = ({
  ...
  const loanDetailsBottomSheetModalRef = useRef<BottomSheetModal>(null);
  ...
  const onOpenLoanDetailsModal = () =>
    loanDetailsBottomSheetModalRef.current?.present();
              ...
              <Box my="md">
                ...
                <Box>
                  <LoanHistoryButton
                    ...
                    onPress={onOpenLoanDetailsModal}
                  />
                </Box>
                <Box>
                  <LoanHistoryButton
