/**
 * export all lottie files like so
 * @example
 * ```ts
...
export { default as backgroundIcons } from "./backgroundIcons.png";
export { default as balance } from "./balance.png";
export { default as map } from "./branchesmap.png";
...
export { default as glo } from "./gloIcon.png";
export { default as imagedisplay } from "./imagedisplay.png";
export { default as insurance } from "./insurance.png";
export { default as key } from "./keyIcon.png";
...
export { default as logoWithBackdrop } from "./logoWithBackdrop.png";
export { default as maskGroup } from "./maskGroupIcon.png";
export { default as modalBackdrop2 } from "./modal2.png";
export { default as modalBackdrop } from "./modalBackdrop.png";
export { default as mtn } from "./mtnIcon.png";
